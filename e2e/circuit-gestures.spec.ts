...
test.describe('drag to group', () => {
  test(
    'holding over another exercise groups them on release',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
  ...
  test(
    'holding squarely on the target is enough, with no extra movement',
    { tag: '@flaky-drag' },
    async ({ page }) => {
  ...
  test(
    'a third exercise joins the same circuit, not a second one',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
  ...
  test(
    'a quick drag still reorders instead of grouping',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
  ...
  test(
    'two members of the same circuit offer no grouping',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
...
test.describe('drag out of a circuit', () => {
  test(
    'dragging a member clear of the block removes it',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
  ...
  test(
    'the keyboard can leave a circuit by arrowing out',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
...
test.describe('adding in place, and uneven rests', () => {
  ...
  test(
    'the plus on a circuit member adds another member',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
  ...
  test(
    'a rest row can be placed between exercises, with its own length',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
      ...
      await page
        .getByRole('button', { name: /^Add a rest after Pushups, in the circuit$/u })
        .click();
  ...
  test(
    'the round rest label explains itself on hover',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
...
test.describe('deleting rows', () => {
  ...
  test(
    'deleting down to one member dissolves the circuit',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
  ...
  test('the round rest label is not truncated', { tag: '@flaky-drag' }, async ({ page }) => {
    await signIn(page);
...
test.describe('swipe to delete', () => {
  test('swiping a row far enough left deletes it', { tag: '@flaky-drag' }, async ({ page }) => {
    await signIn(page);
  ...
  test(
    'a short swipe springs back and deletes nothing',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
  ...
  test('a circuit member can be swiped away too', { tag: '@flaky-drag' }, async ({ page }) => {
    await signIn(page);
...
test.describe('leaving a circuit', () => {
   ...
   */
  test(
    'a two-exercise workout that is all circuit can still be broken up',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
  ...
  test(
    'swiping a member right leaves the rest of the circuit intact',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
  ...
  test(
    'a short right swipe springs back and stays in the circuit',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
  ...
  test(
    'a row outside a circuit has nothing to reveal on the right',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
...
test.describe('dragging out of a circuit', () => {
  test(
    'a workout that is entirely one circuit can still be broken up',
    { tag: '@flaky-drag' },
    async ({ page }) => {
  ...
  test(
    'pulling one member out leaves the rest of the circuit intact',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
  ...
  test(
    'dragging up out of the block works too, which is the phone case',
    { tag: '@flaky-drag' },
    async ({ page }) => {
  ...
  test(
    'a small wobble still reorders rather than leaving',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
  ...
  test(
    'reordering inside the block does not leave it',
    { tag: '@flaky-drag' },
    async ({ page }) => {
  ...
  test(
    'a row outside a circuit is not freed sideways',
    { tag: '@flaky-drag' },
    async ({ page }) => {
  ...
  test(
    'the keyboard leaves with u, which needs no sideways room',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
...
test.describe('adding after a circuit', () => {
  test(
    'the insert row below the block adds outside it',
    { tag: '@flaky-drag' },
    async ({ page }) => {
  ...
  test(
    'a rest can be placed after a circuit rather than inside it',
    { tag: '@flaky-drag' },
    async ({ page }) => {
      await signIn(page);
